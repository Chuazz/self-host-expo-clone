...
module.exports.getRequestParams = ({ query, headers }) => {
  ...
  if (!project || typeof project !== "string") {
    throw new Err.BadRequest(
      "No expo-project header or project query provided."
    );
  }
  ...
  if (platform !== "ios" && platform !== "android") {
    throw new Err.BadRequest(
      "Missing expo-platform header or platform query provided. Expected either ios or android."
    );
  }
  ...
  if (!runtimeVersion || typeof runtimeVersion !== "string") {
    throw new Err.BadRequest(
      "Missing expo-runtime-version header or runtime-version query provided."
    );
  }
  ...
  if (!releaseChannel || typeof releaseChannel !== "string") {
    throw new Err.BadRequest(
      "Missing expo-channel-name header orchannel-name query provided."
    );
  }
